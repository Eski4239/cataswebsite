    ...
    <>
      ...
      <section className="section-shell grid gap-10 lg:grid-cols-2">
        ...
        <article>
          ...
          <h2 className="mt-3 font-heading text-5xl">
            Wine is one of the few ways we can taste history.
          </h2>

          <p className="mt-5 text-muted">
            Each narrative brings people, places, memory, and human
            connection into one shared glass.
          </p>
        </article>
      </section>
